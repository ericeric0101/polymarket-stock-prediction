    ...
    def test_journal_reprice_hysteresis_and_touch_without_fill(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            quote, action = journal.sync_maker_shadow_quote(
                ...
                outcome="DOWN",
                limit_price=0.52,
                fair_probability=0.528,
                theoretical_edge=0.008,
                best_bid=0.52,
                best_ask=0.54,
                payload={"source": "test"},
                observed_at=now,
            ...
            _, same_action = journal.sync_maker_shadow_quote(
                ...
                outcome="DOWN",
                limit_price=0.52,
                fair_probability=0.527,
                theoretical_edge=0.007,
                best_bid=0.52,
                best_ask=0.54,
                payload={"source": "test"},
                observed_at=now,
            ...
            held, held_action = journal.sync_maker_shadow_quote(
                ...
                outcome="DOWN",
                limit_price=0.51,
                fair_probability=0.518,
                theoretical_edge=0.008,
                best_bid=0.50,
                best_ask=0.53,
                payload={"source": "test"},
                minimum_reprice_price_change=0.02,
                minimum_quote_lifetime_seconds=30,
