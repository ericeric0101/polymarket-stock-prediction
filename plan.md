...
| 3.25 Volatility-regime disagreement gate | Complete: primary versus comparison fair probabilities are stored and summarized; fallback disagreement preserves the signal but blocks paper entry. | IV-valid behavior remains separate; no option IV is fabricated. |
