...
COMMAND_GROUPS = {
    ...
    "data": (
        "download-yahoo-closes",
        "batch-backfill-settled-markets",
        "backfill-settled-market-data",
        "backfill-pyth-intraday-spots",
        "backtest-pyth-clob",
    ),
    "research": (
        "evaluate-baseline",
        "evaluate-nasdaq-baseline",
        "historical-backtest",
        "replay-settled",
        "replay-observations",
    ...
    "above_x": (
        ...
        "above-x-coverage",
        "backtest-above-x",
        "walk-forward-above-x-veto",
        "sync-above-x-veto-shadow",
        "discover-price-ladders",
        "collect-price-ladders",
        "settle-price-ladders",
        "price-ladder-report",
    ),
    "operations": (
        "stream-shadow",
